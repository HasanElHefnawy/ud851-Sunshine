...
//      TODO (8) Use mDetailBinding to display the date
        mDetailBinding.primaryWeatherInfo.dateView.setText(dateText);
        ...
        mDetailBinding.primaryWeatherInfo.iconView.setImageResource(SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId));
        /* Use the weatherId to obtain the proper description */
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);

//      TODO (15) Create the content description for the description for a11y
        String descriptionA11y = description;
...
//      TODO (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.descriptionView.setText(description);
        mDetailBinding.primaryWeatherInfo.descriptionView.setContentDescription(descriptionA11y);

//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryWeatherInfo.iconView.setContentDescription(descriptionA11y);
...
//      TODO (17) Create the content description for the high temperature for a11y
        String highTemperatureA11y = highString;
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.highTemperatureView.setText(highString);
        mDetailBinding.primaryWeatherInfo.highTemperatureView.setContentDescription(highTemperatureA11y);
...
//      TODO (18) Create the content description for the low temperature for a11y
        String lowTemperatureA11y = lowString;
...
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.lowTemperatureView.setText(lowString);
        mDetailBinding.primaryWeatherInfo.lowTemperatureView.setContentDescription(lowTemperatureA11y);
...
//      TODO (20) Create the content description for the humidity for a11y
        String humidityA11y = humidityString;

//      TODO (12) Use mDetailBinding to display the humidity and set the content description
        /* Set the text to display the humidity */
        mDetailBinding.extraWeatherDetails.humidityView.setText(humidityString);
        mDetailBinding.extraWeatherDetails.humidityView.setContentDescription(humidityA11y);

//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        String humidityLabelA11y = "humidityLabelA11y";
        mDetailBinding.extraWeatherDetails.humidityLabelView.setContentDescription(humidityLabelA11y);
...
//      TODO (21) Create the content description for the wind for a11y
        String windA11y = windString;

//      TODO (13) Use mDetailBinding to display the wind and set the content description
        /* Set the text to display wind information */
        mDetailBinding.extraWeatherDetails.windView.setText(windString);
        mDetailBinding.extraWeatherDetails.windView.setContentDescription(windA11y);

//      TODO (22) Set the content description of the wind label to the wind a11y String
        String windLabelA11y = "windLabelA11y";
        mDetailBinding.extraWeatherDetails.windLabelView.setContentDescription(windLabelA11y);
...
//      TODO (23) Create the content description for the pressure for a11y
        String pressureA11y = pressureString;
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeatherDetails.pressureView.setText(pressureString);
        mDetailBinding.extraWeatherDetails.pressureView.setContentDescription(pressureA11y);

//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        String pressureLabelA11y = "pressureLabelA11y";
        mDetailBinding.extraWeatherDetails.pressureLabelView.setContentDescription(pressureLabelA11y);
